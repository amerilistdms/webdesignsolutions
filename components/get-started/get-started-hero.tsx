  ...
  return (
    <section className="site-hero overflow-hidden text-white">
      <div
        ...
        aria-hidden
      />
      <div className="absolute inset-0 bg-[#040c1c]/65" aria-hidden />
      ...
      <div className="site-hero__content flex w-full flex-col items-center gap-8 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
