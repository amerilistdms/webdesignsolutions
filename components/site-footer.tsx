...
export function SiteFooter() {
  return (
    <footer
      id="contact"
      className="site-chrome mt-auto border-t border-white/10 bg-[var(--color-footer)] text-white"
    >
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-5 text-xs font-semibold uppercase tracking-wider text-white">
              Follow us
            </p>
            <div className="mt-3">
          ...
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-2 text-sm text-white">
              {mainNavLinks.map(({ href, label }) => (
                <li key={href}>
                  <Link href={href} className="text-white transition hover:text-white/80">
                    {label}
                  </Link>
                </li>
              ))}
            ...
            <ul className="mt-4 space-y-3 text-sm text-white">
              ...
              <li>
                <a
                  ...
                  className="font-medium tabular-nums text-white transition hover:text-white/80"
                >
                  1 800 457 2899
                </a>
              </li>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-white/10 pt-8 text-xs text-white sm:flex-row sm:items-center sm:justify-between">
          <p className="text-white">
            Copyright © {new Date().getFullYear()} AWD, a division of The Amerilist Companies.
          </p>
